						...
						<form @submit.prevent="submitForm">
							<div class="field">
								...
								<p
									...
									:style="{
										visibility:
											nomField.meta.touched && !nomField.meta.valid ? 'visible' : 'hidden',
									}"
								>
							...
							<div class="field">
								...
								<p
									...
									:style="{
										visibility:
											prenomField.meta.touched && !prenomField.meta.valid ? 'visible' : 'hidden',
									}"
								>
							...
							<div class="field">
								...
								<p
									class="has-text-danger"
									:style="{
										visibility: idField.meta.touched && !idField.meta.valid ? 'visible' : 'hidden',
									}"
								>
							...
							<div class="field">
								...
								<p
									...
									:style="{
										visibility:
											confirmPasswordField.meta.touched && !confirmPasswordField.meta.valid
												? 'visible'
												: 'hidden',
									}"
								>
							...
							<div class="field is-grouped is-justify-content-center">
								<div class="control">
									<button type="submit" class="button is-link" :disabled="!formMeta.valid">
										S'enregistrer
									</button>
								</div>
								<div class="control">
